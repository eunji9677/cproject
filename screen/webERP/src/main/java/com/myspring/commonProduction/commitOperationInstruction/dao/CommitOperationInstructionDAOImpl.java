 ...
 * 
 * @Repository("CommitOperationInstructionDAOImpl") public class
 * CommitOperationInstructionDAOImpl implements CommitOperationInstructionDAO{
 * 
 * @Autowired private SqlSession sqlSession;
 * 
 * @Override public List selectAllProductionPlanInfo() throws
 * DataAccessException { List<CommitOperationInstructionVO> infoList = null;
 * infoList =
